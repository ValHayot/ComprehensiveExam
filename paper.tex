...
\begin{document} 
    ...
    \chapter{Reproducibility}\label{reproducibility}
        Reproducibility is a vital component to all scientific workflows. 
        ...
        infrastructure\note{cite}. It have been found that more than 70\% of
        ...
        dissimilar results. As a result, it is necessary that specific details 
        ...
        issue of reproducibility. Section~\ref{prov} will discuss how the 
        ...
        \section{Provenance Tracking}\label{prov}
            Provenance tracking is of vital importance to scientific reporting.
            On its own, source code is insuffient to reproduce the workflow 
            ...
            As explained by the W3 PROW specification, provenance details 
            information on the data, the tools involved in its creation and the
            responsible parties. Provenance tracking, in the context of 
            workflows, is the the act of capturing provenance data during
            workflow execution. With detailed provenance and access to source 
            codeinfo, researchers should have enough information to be able 
            to reproduce workflows.

            To to the importance of provenance tracking for scientific 
            workflows several workflow engines adapted strategies to capture 
            comprehensive provenance data. These include Nipype, PSOM, FastR, 
            LONI, Taverna, Pegasus, Nextflow, Galaxy. Other workflow engines,
            such as SPM, AA, Pydpiper,            
