...
\begin{document} 
    ...
    \chapter{Introduction}
        ...
        Nipype~\cite{nipype}, Pipeline System for Octave and Matlab (PSOM)~\cite{10.3389/fninf.2012.00007}, LONI~\cite{REX20031033}, SPM~\cite{spm}, FastR~\cite{10.3389/fict.2016.00015},
        Automatic Analysis (AA)~\cite{10.3389/fninf.2014.00090} and Pydpiper~\cite{10.3389/fninf.2014.00067}. These 
    ...
    \chapter{Performance}\label{performance}
        ...
        \section{Evaluation of BigData Frameworks for Scientific Computing}     
            ...
            ~\cite{ariel} compared Spark, Dask, SciDB, Myria and TensorFlow on
            a neuroimaging and astronomy use case. It was found that Dask, 
            Myria and Spark performed consistently better and had comparable 
            ...
            when the individual images are larger due to the lack of overlap 
            between shuffle and map stages \note{revise this}. Overall it was
