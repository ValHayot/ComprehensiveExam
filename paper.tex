...
\begin{document} 
    ...
    \chapter{Performance}\label{performance}
        ...
        introduced \weird{into the mix}. The dichotomy remains between scientific 
        ...
        they were intended to be used on. That is, as scientific workflows \tristan{use 'engine' and 'workflows' consistently (think nipype vs fmriprep).}
        ...
        \section{Filesystems}\label{fs}
            ...
            \subsection{Strategies}
                \subsubsection{in-memory computing}
                    ...
                    scheduling tasks to nodes where the memory is located \tristan{You mean where RAM is available or where the data is located?}. Dask
                ...
                \subsubsection{Data locality}
                    ...
                    favorable partition dictated by delay scheduling \tristan{ignoring data locality?}.
    ...
    \chapter{Portability}\label{portability}
       ...
       \section{Tool installation}
            ...
            Unless a user is building a workflow exclusively based on custom
            functions or using a monolithic workflow engine such as SPM, they
            will need to install the tools necessary for their workflow on
            their computer or cluster \tristan{replace computer or cluster by infrastructure?}. Depending on the workflow engine 
            selected, this may be managed by the engine, or the user may be 
            left to install the dependencies themselves. Workflow engines that
