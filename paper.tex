...
\begin{document} 
    ...
    \chapter{Workflow composition}\label{workcomp}
        ...
        \section{Modularity}\label{mod}
            ...
            LONI and FastR are other examples of workflow engines that use an
            XML interface to describe CLIs. LONI enables generation of the 
            XML-based module interface through its GUI. The module interface
