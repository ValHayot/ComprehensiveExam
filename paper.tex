...
\begin{document} 
    ...
    \chapter{Workflow composition}\label{workcomp}
        ...
        \section{Workflow language}\label{lang}
            ...
            SPM, Taverna, LONI and Galaxy. \note{double-check that none have a 
            programming API.Loni does..i think SPM does too}
            ...
            workflow composition, such as LONI, enable more experienced users to
            script their workflow. Six different programming
            ...
            Language (CWL). This can be seen in 
