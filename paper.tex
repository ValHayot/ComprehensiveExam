...
having started of as a pipelining system for SPM. User may define their pipeline
...
be integrated into aa which can be easily accomplished through XML interfaces. It is also possible to easily
parallelize the code in qsub, if required. 
        \subsection{Pipeline description}
...
each task is provided with its own unique folder. The aa engine will ensure that
the necessary input data is located in the folder before task execution and also
acquiring the outputs after task completion.
