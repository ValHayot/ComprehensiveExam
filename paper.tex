...
\begin{document} 
    ...
    \chapter{Performance}\label{performance}
        ...
        \section{Filesystems}\label{fs}
            ...
            Scientific workflows historically relied on I/O to transfer data
            between nodes. As scientific workflows are usually executed on
            HPC infrastructure, this meant writing to a filesystem such as 
            Lustre 
