...
\begin{document} 
    ...
    \chapter{Workflow composition}\label{workcomp}
        ...
        \section{Workflow language}\label{lang}
            ...
            Additionally, BigData frameworks are better suited for the 
        ...
        \section{Modularity}\label{mod}
            ...
            their custom tools. Workflow engines, such as AA, were thus 
            ...
            LONI, FastR, Taverna and Pegasus are other examples of workflow 
            engines that 
            ...
            Some workflows do not require module interfaces, as is the case with
            Make. The pipeline is expressed in a makefile containing a set of 
            rules. Rules consist of three components: targets, dependencies and
            recipes. The target is the output (typically a file) of the 
            ...
            generate the target from its dependencies. As makefiles are written
            entirely using shell commands, it is not necessarily to create 
            interfaces to the shell commands of the tools. 
